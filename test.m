...
effector=4;
n=3;
B(:,1:effector)=[-0.50004   00001       0.5001   00002;
...
for i=1:length(X)%length(M_des(1:1000,1))%(N+1)^2%
v=1*[X(i);Y(i);Z(i)];% ÐéÄâÖ¸ÁîM_des(i,:)'%
IN_MAT(1:3,end-1)=v;
...
[u1] = LPwrap(IN_MAT);
x1(:,i)=Constrain(u1(INDX>0.5),uMin,uMax);
